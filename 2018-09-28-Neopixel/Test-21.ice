    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Fase 2. Test 1: Encendido de varios LEDs  \nCambiando el parámetro de número de LEDs podemos encender entre 2 - 12 LEDs  \nCon el swith determinado su estado (apagado, blanco). Con el pulsador actuamos  \nFUNCIONA\n",
            "readonly": true
          },
          "position": {
            "x": -464,

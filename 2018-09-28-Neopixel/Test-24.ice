{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f6af0311-1289-4da0-adef-3495928362c8",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "e00fc101-d8fd-44f3-b195-d255e3b5f6f3",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "eb92a6e1-61f8-4a88-a013-5ecfb7b7dd6d",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "9d21a33f-fdef-4589-a88c-8f85e145db25",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "9a169df5-28bc-4a83-8a30-4c88c32b3845",
          "type": "basic.input",
          "data": {
            "name": "Pulsador",
            "pins": [
        ...
        {
          "id": "add811f4-c552-43bf-a3a2-608a17b5b850",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "5887b259-f2d1-4ef6-83e2-5dd08ce8bfad",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "6e3ce444-e955-44df-a53f-84c9266eaaa8",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "1",
        ...
        {
          "id": "c90c1b13-7721-4ed4-8d26-f5c77d2c8f8c",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "3",
        ...
        {
          "id": "97a58ab4-1709-4d94-8b9e-b5f5ecb8a8a5",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "15",
        ...
        {
          "id": "a91f1515-fd8d-43d1-b85a-32220712fa77",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "15",
        ...
        {
          "id": "797165e2-a097-4ad9-a59f-7c2fe5318e6e",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "24'h000100",
        ...
        {
          "id": "ad153956-a87f-4f23-8802-edecbae9f864",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Fase 2. Test 4:  Encendido de 3 leds con colores R,G,B\n\nFUNCIONA. Hay que hacer limpieza.......\n",
            "readonly": true
          },
          "position": {
            "x": -1280,
        ...
        {
          "id": "9db01517-56e0-49b9-a2f0-82e4f9ca3a60",
        ...
        {
          "id": "f5bc6fbf-2ed3-4625-95a1-283e46d7224d",
          "type": "basic.code",
          "data": {
            "code": "\nreg [23:0] q = 24'h000000;\n\nalways @(posedge clk)\n  if (load)\n    q <= rgb;\n  else\n    if (shift)\n      q <= {q[22:0], 1'b0};\n    \nassign o = q[23];\n",
            "params": [
              {
                "name": "INI"
              }
        ...
        {
          "id": "820033a6-911a-4710-905e-9a4d9172c3a2",
        ...
        {
          "id": "311f037e-fa2e-425f-9fe7-e205000a87f9",
        ...
        {
          "id": "8e1ccf61-832a-403c-98a3-dd500daac51c",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": -1168,
            "y": 632
        ...
        {
          "id": "a1fab268-d1fd-4abe-9015-9d847ffa9cdd",
          "type": "e74cd1645bed81077ebe3c8266bbb396a3a61e34",
          "position": {
            "x": 48,
            "y": 472
        ...
        {
          "id": "f14e1f0e-ee5d-45cb-9f0b-314521cea109",
        ...
        {
          "id": "b176101f-f4bb-4892-81f3-a7610e1c8ee0",
        ...
        {
          "id": "34ac517e-c3ff-4dfb-b13c-a3efaae8d068",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": -848,
            "y": -360
      ...
      "wires": [
        {
          "source": {
            "block": "9a169df5-28bc-4a83-8a30-4c88c32b3845",
            "port": "out"
          },
          "target": {
            "block": "ad153956-a87f-4f23-8802-edecbae9f864",
        ...
        },
        {
          ...
          "target": {
            "block": "9db01517-56e0-49b9-a2f0-82e4f9ca3a60",
        ...
        {
          "source": {
            "block": "797165e2-a097-4ad9-a59f-7c2fe5318e6e",
            "port": "constant-out"
          },
          "target": {
            "block": "f5bc6fbf-2ed3-4625-95a1-283e46d7224d",
            "port": "INI"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "820033a6-911a-4710-905e-9a4d9172c3a2",
        ...
        {
          "source": {
            "block": "97a58ab4-1709-4d94-8b9e-b5f5ecb8a8a5",
            "port": "constant-out"
          },
          "target": {
            "block": "820033a6-911a-4710-905e-9a4d9172c3a2",
        ...
        },
        {
          ...
          "target": {
            "block": "eb92a6e1-61f8-4a88-a013-5ecfb7b7dd6d",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "add811f4-c552-43bf-a3a2-608a17b5b850",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "e00fc101-d8fd-44f3-b195-d255e3b5f6f3",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "6e3ce444-e955-44df-a53f-84c9266eaaa8",
            "port": "constant-out"
          },
          "target": {
            "block": "311f037e-fa2e-425f-9fe7-e205000a87f9",
            "port": "65194b18-5d2a-41b2-bd86-01be99978ad6"
          }
        },
        {
          "source": {
            "block": "8e1ccf61-832a-403c-98a3-dd500daac51c",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "311f037e-fa2e-425f-9fe7-e205000a87f9",
        ...
        },
        {
          ...
          "target": {
            "block": "f6af0311-1289-4da0-adef-3495928362c8",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "9d21a33f-fdef-4589-a88c-8f85e145db25",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "a91f1515-fd8d-43d1-b85a-32220712fa77",
            "port": "constant-out"
          },
          "target": {
            "block": "a1fab268-d1fd-4abe-9015-9d847ffa9cdd",
            "port": "a0ae7ae6-94bd-4958-8871-4a00574de708"
          },
          "vertices": []
        },
        ...
        },
        {
          ...
          "target": {
            "block": "f14e1f0e-ee5d-45cb-9f0b-314521cea109",
        ...
        {
          "source": {
            "block": "b176101f-f4bb-4892-81f3-a7610e1c8ee0",
        ...
        },
        {
          ...
          "target": {
            "block": "5887b259-f2d1-4ef6-83e2-5dd08ce8bfad",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "34ac517e-c3ff-4dfb-b13c-a3efaae8d068",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "b176101f-f4bb-4892-81f3-a7610e1c8ee0",
        ...
        {
          "source": {
            "block": "c90c1b13-7721-4ed4-8d26-f5c77d2c8f8c",
            "port": "constant-out"
          },
          "target": {
            "block": "b176101f-f4bb-4892-81f3-a7610e1c8ee0",
